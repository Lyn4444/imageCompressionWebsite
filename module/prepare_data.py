...
image_paths_per_label = map(lambda one_dir: map(lambda one_file: os.path.join(tparam.images_path, one_dir, one_file),
                                                os.listdir(os.path.join(tparam.images_path, one_dir))), image_dir_list)
